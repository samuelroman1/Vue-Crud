        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div id="botonbusca">
                                    ...
                                    &#160
                                    <router-link :to="{ name: 'listarDepartamento' }"
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{ name: 'listarDepartamento' }" type="button"
...
export default {
    ...
    methods: {
        ...
        Buscar(id) {
            if (id > 0) {
                axios.get('https://localhost:7051/Departamento/' + id).then((response) => {
                    ...
                    if (this.Departamentos == null) {
                        ...
                        document.getElementById('nombre').value = this.Departamentos.nombre;
