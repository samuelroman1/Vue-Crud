        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div id="botonbusca">
                                    ...
                                    &#160
                                    <router-link :to="{ name: 'listarPuesto' }"
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{ name: 'listarPuesto' }" type="button"
                            class="btn btn-outline-primary">Finalizar</router-link>|</div>
                    <div id="botones" class="row" style="display: none;">
                        <div class="btn-group" role="group">
                            |<button type="submit" class="btn btn-outline-primary">Actualizar</button>|
                            |<router-link :to="{ name: 'listarPuesto' }" class="btn btn-outline-danger">Cancelar</router-link>|
                        </div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7051/Puesto/' + this.pkpuesto, cuerpo).then((resutl) => {
