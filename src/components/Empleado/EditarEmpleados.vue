<template>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">Actualizar Empleados</div>
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div id="botonbusca">
                                    ...
                                    &#160
                                    <router-link :to="{ name: 'listarEmpleados' }"
				  ...
				  <option v-for=" departamento in Departamentos" :value="departamento.pkDepartamento" :key="departamento.pkDepartamento">{{departamento.nombre}}</option>
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{ name: 'listarEmpleados' }" type="button"
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7051/Empleado/' + this.pkEmpleado, cuerpo).then((resutl) => {
            ...
            if (id > 0) {
                axios.get('https://localhost:7051/Empleado/' + id).then((response) => {
                    ...
                    if (this.Empleados == null) {
                        ...
                        document.getElementById('nombre').value = this.Empleados.nombre;
                        document.getElementById('apellidos').value = this.Empleados.apellidos;
                        document.getElementById('dirreccion').value = this.Empleados.dirreccion;
                        document.getElementById('ciudad').value = this.Empleados.ciudad;
                        document.getElementById('fkPuesto').value = this.Empleados.fkPuesto;
                        document.getElementById('fkDepartamento').value = this.Empleados.fkDepartamento;
